      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-md-3 footer-links">
          ...
          <ul>
            ...
            <li><i class="bi bi-chevron-right"></i> <a href="kurikulum.php">Kurikulum</a></li>
        ...
        <div class="col-lg-2 col-md-3 footer-links">
          <h4>Program Kami</h4>
          <ul>
            <li><i class="bi bi-chevron-right"></i> <a href="kurikulum.php#web">Web Engineering</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="kurikulum.php#web">Mobile Engineering</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="kurikulum.php#web">AI & Data Science</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="kurikulum.php#web">Cloud Computing</a></li>
          </ul>
        </div>
