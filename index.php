      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h1 data-aos="fade-up">Diploma Tiga Farmasi</h1>
            <p data-aos="fade-up" data-aos-delay="100">Program Studi Diploma Tiga</p>
            <div class="d-flex flex-column flex-md-row" data-aos="fade-up" data-aos-delay="200">
              <a href="https://pmb-mip.politeknikmeta.ac.id/" class="btn-get-started">Daftar Sekarang <i
          ...
          <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out">
            <img src="assets/img/heroimg2.png" class="img-fluid animated" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h3>Tentang Kami</h3>
              <h2>Program Studi Diploma Tiga Farmasi</h2>
              <p>
                Program Diploma Tiga (D3) Farmasi merupakan program pendidikan vokasi yang berfokus pada pengembangan
                keterampilan dan pengetahuan di bidang kefarmasian. Program ini bertujuan untuk menghasilkan tenaga
                teknis kefarmasian yang kompeten, profesional, dan siap bekerja di berbagai fasilitas pelayanan
                kesehatan seperti apotek, rumah sakit, maupun industri farmasi.

                Melalui pembelajaran teori dan praktik yang seimbang, mahasiswa dibekali kemampuan dalam pengelolaan
                obat, peracikan obat, serta pelayanan kefarmasian kepada masyarakat. Program ini juga menekankan
                pentingnya etika profesi dan tanggung jawab dalam mendukung peningkatan kualitas pelayanan kesehatan.
              </p>
    ...
    <section id="stats" class="stats section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item d-flex align-items-center w-100 h-100">
              <i class="bi bi-mortarboard color-orange flex-shrink-0" style="color: #ee6c20;"></i>
              <div>
                <span data-purecounter-start="0" data-purecounter-end="185" data-purecounter-duration="1"
                  class="purecounter"></span>
                <p>Alumni Sukses</p>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item d-flex align-items-center w-100 h-100">
              <i class="bi bi-building color-green flex-shrink-0" style="color: #15be56;"></i>
              <div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item d-flex align-items-center w-100 h-100">
              <i class="bi bi-briefcase color-pink flex-shrink-0" style="color: #bb0852;"></i>
              <div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="pricing-tem">
              ...
              <a href="beasiswa.html" class="btn-buy">Info Beasiswa</a>
            </div>
          </div><!-- End Pricing Item -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="faq-container">
              ...
              <div class="faq-item faq-active">
                <h3>Apa itu Program Studi Farmasi?</h3>
                <div class="faq-content">
                  <p>Teknologi Rekayasa Perangkat Lunak (TRPL) adalah program studi yang berfokus pada teknik
                    pengembangan perangkat lunak skala industri, mulai dari analisis kebutuhan, desain, implementasi,
                    hingga pengujian dan pemeliharaan.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>Apa perbedaan TRPL dengan Informatika biasa?</h3>
                <div class="faq-content">
                  <p>TRPL lebih menekankan pada aspek "Rekayasa" dan "Terapan" (Vokasi). Mahasiswa lebih banyak belajar
                    melalui praktik langsung dengan standar industri terkini dibandingkan dengan teori murni.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>Bagaimana prospek kerja lulusan TRPL?</h3>
                <div class="faq-content">
                  <p>Lulusan memiliki peluang karir yang sangat luas sebagai Software Engineer, Developer (Web, Mobile,
                    Game), QA Engineer, DevOps, Sistem Analyst, hingga AI Engineer di berbagai startup maupun perusahaan
                    multinasional.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="faq-container">
              ...
              <div class="faq-item">
                <h3>Apakah ada program magang industri?</h3>
                <div class="faq-content">
                  <p>Ya, program TRPL mewajibkan magang industri selama 1-2 semester untuk memberikan pengalaman kerja
                    nyata kepada mahasiswa sebelum lulus.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>Fasilitas apa saja yang disediakan?</h3>
                <div class="faq-content">
                  <p>Kami menyediakan laboratorium komputer high-end, server pribadi untuk deployment, akses ke library
                    premium sertifikasi global, hingga Creative Hub untuk kolaborasi proyek.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>Apakah gelar lulusan TRPL diakui secara internasional?</h3>
                <div class="faq-content">
                  <p>Lulusan bergelar Sarjana Terapan (S.Tr.Kom) yang setara dengan gelar Bachelor of Engineering
                    (B.Eng) atau Applied Science, yang sangat dihargai oleh industri global.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
